...
set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS18 } [get_ports { switches[8] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
set_property -dict { PACKAGE_PIN U8   IOSTANDARD LVCMOS18 } [get_ports { switches[9] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
set_property -dict { PACKAGE_PIN R16    IOSTANDARD LVCMOS33 } [get_ports { switches[10] }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { switches[11] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN H6   IOSTANDARD LVCMOS33 } [get_ports { switches[12] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
